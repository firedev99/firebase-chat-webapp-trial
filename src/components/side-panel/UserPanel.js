...
class UserPanel extends Component {
    ...
    dropdownOptions = () => [
        {
            key: 'user',
            text: <span>Signed is as <strong style={{ color: 'black' }}>{this.state.user.displayName}</strong></span>,
            disabled: true
        },
        {
            key: 'avatar',
    ...
    uploadCroppedImage = () => {
        ...
        storageRef
            .child(`avatars/users/${userRef.uid}`).put(blob, metaData)
            .then(snap => {
    ...
    changeAvatar = () => {
        ...
        this.state.usersRef
            .child(this.state.user.uid).update({
